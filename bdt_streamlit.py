...
def _get_credentials() -> tuple[str, str]:
    try:
        ...
        # Fallback local only: environment variables (no hardcoded secrets in source)
        user = os.getenv("APP_USER", "__MISSING_USER__")
        code = os.getenv("APP_CODE", "__MISSING_CODE__")
